          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-[#3047D8] px-7 py-4 text-sm font-semibold text-white shadow-lg shadow-blue-200 transition duration-300 hover:-translate-y-1 hover:bg-[#2538B8]"
              >
                Follow on Instagram
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center gap-2 rounded-xl border border-[#3047D8] bg-white px-7 py-4 text-sm font-semibold text-[#3047D8] transition duration-300 hover:-translate-y-1 hover:bg-blue-50"
              >
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-2.5 lg:justify-start">
              ...
              <Link
                ...
                className="rounded-full border border-blue-100 bg-white px-4 py-2 text-sm font-medium text-[#3047D8] transition hover:-translate-y-0.5 hover:border-[#3047D8] hover:shadow-sm"
              >
                Fresher Jobs
              </Link>
          ...
          <div className="relative mx-auto w-full max-w-xl lg:max-w-none">
            ...
            <div className="relative rounded-[28px] border border-blue-100 bg-white p-5 shadow-2xl shadow-blue-100/70 sm:p-7">
              ...
              <div className="mt-5 space-y-3">
                ...
                <Link
                  href="/it-jobs-kerala"
                  className="group flex items-center justify-between rounded-2xl border border-gray-100 bg-[#F8FAFC] p-4 transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:bg-white hover:shadow-md"
                >
                  ...
                  <span className="text-[#3047D8] transition-transform group-hover:translate-x-1">
                    →
                  </span>
                </Link>
...
<Link
  href="/community"
  className="group mt-5 block rounded-2xl bg-[#11194F] p-5 text-left text-white transition duration-300 hover:-translate-y-1 hover:bg-[#182162] hover:shadow-lg"
>
  <div className="flex items-center justify-between gap-4">
    ...
    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/10 transition duration-300 group-hover:translate-x-1 group-hover:bg-white/20">
      →
    </div>
  </div>
</Link>
